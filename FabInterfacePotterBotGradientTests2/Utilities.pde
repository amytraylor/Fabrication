...
class Vec4 {
  float x, y, z, layerHeight, extrusionRate;
  Vec4(float _x, float _y, float _z, float _layerHeight, float _extrusionRate) {
    x = _x;
    y = _y;
    z = _z;
  ...
  Vec4(float _x, float _y, float _z, float _extrusionRate) {
    x = _x;
    y = _y;
    z = _z;
    extrusionRate = _extrusionRate;
